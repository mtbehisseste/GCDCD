...
C:\folder\WINdbgFolder\ML /c /coff /Zi /Fl main.asm printMap.asm inputHandle.asm inputHandleKeyboard.asm
...
LINK /debug /subsystem:console  /entry:start /out:main.exe main.obj printMap.obj inputHandle.obj inputHandleKeyboard.obj Kernel32.lib irvine32.lib user32.lib
if errorlevel 1 goto terminate
